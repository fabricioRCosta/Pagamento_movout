...
const styles = StyleSheet.create({
  ...
  headerSubtitle: { color: 'rgba(255,255,255,0.9)', fontSize: 14, marginBottom: 24 },
  addressCard: {
  ...
  dotOrigin: { backgroundColor: 'black' },
  ...
  addressLabel: { color: '#6B7280', fontSize: 12, marginBottom: 4 },
  addressInput: {
    color: '#1F2937',
    fontSize: 15,
    fontWeight: '500',
  ...
  mapPreview: { height: 180, borderRadius: 12, overflow: 'hidden', marginTop: 8 },
  ...
  weightInput: { fontSize: 16, fontWeight: '600', color: '#1F2937', width: 60, padding: 0 },
  unitText: { fontSize: 12, color: '#6B7280', marginLeft: 4 },
  ...
  fragileTextActive: { color: '#DC2626' },
  warningBox: {
    marginTop: 8,
    padding: 10,
  ...
  uploadSection: { marginVertical: 16, paddingTop: 12, borderTopWidth: 1, borderTopColor: '#E5E7EB' },
  uploadButton: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 10,
  ...
  uploadButtonSuccess: { backgroundColor: '#ECFDF5', borderColor: '#10B981', borderStyle: 'solid' },
  uploadButtonError: { backgroundColor: '#FEF2F2', borderColor: '#EF4444', borderStyle: 'solid' },
  uploadText: { color: '#374151', fontSize: 13, fontWeight: '500', flex: 1 },

  descSection: { marginBottom: 10 },
  descLabel: { fontSize: 14, color: '#374151', fontWeight: '500' },
  descInput: { borderWidth: 1, borderColor: '#D1D5DB', borderRadius: 8, padding: 12, height: 80, textAlignVertical: 'top' },
  ...
  prioritySelected: {},
  priorityIcon: { width: 40, height: 40, borderRadius: 8, justifyContent: 'center', alignItems: 'center', marginBottom: 8 },
  priorityLabel: { fontSize: 12, color: '#1F2937', marginBottom: 2, fontWeight: '600' },
  prioritySubtitle: { fontSize: 10, color: '#6B7280' },
  ...
  vehicleName: { fontSize: 16, color: '#1F2937', fontWeight: '500' },
  vehicleDetails: { fontSize: 12, color: '#6B7280' },
  vehiclePrice: { color: '#F4A259', fontWeight: 'bold', fontSize: 16 },

  useLocationBtn: { backgroundColor: 'black', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 4 },
  useLocationText: { color: 'white', fontSize: 10, fontWeight: 'bold' },
  searchingText: { color: '#6B7280', fontSize: 10, marginTop: 4, fontStyle: 'italic' },
  ...
  suggestionItem: { padding: 12, borderBottomWidth: 1, borderBottomColor: '#E5E7EB', backgroundColor: '#FFF' },
